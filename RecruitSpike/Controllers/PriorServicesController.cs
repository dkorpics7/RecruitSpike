...
namespace RecruitSpike.Controllers
{
    public class PriorServicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PriorServiceID,Service1,Service2,Service3")] PriorService priorService)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PriorServiceID,Service1,Service2,Service3")] PriorService priorService)
        {
            if (ModelState.IsValid)
            {
