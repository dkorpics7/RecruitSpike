...
namespace RecruitSpike.Controllers
{
    public class MainstepsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MainstepID,Number,Name,DueDate,IsDone,Notes,Effort,RoadmapID")] Mainstep mainstep)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MainstepID,Number,Name,DueDate,IsDone,Notes,Effort,RoadmapID")] Mainstep mainstep)
        {
            if (ModelState.IsValid)
            {
